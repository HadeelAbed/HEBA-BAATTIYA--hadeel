...
export const IMG = {
  ...
  // Ready to Wear — 7 models from /rtw/ subfolders
  // 1. أسود (Black)
  readToWear: l("/rtw/black/DSC_1357 copy.jpg"),
  readWear1A: l("/rtw/black/DSC_1357 copy.jpg"),
  readWear1B: l("/rtw/black/DSC_1392 copy.jpg"),
  readWear1C: l("/rtw/black/DSC_1515 copy.jpg"),
  // 2. احمر (Red)
  readWear2A: l("/rtw/red/DSC_6690 copy 2.jpg"),
  readWear2B: l("/rtw/red/DSC_6829 copy.jpg"),
  readWear2C: l("/rtw/red/DSC_6869 copy.jpg"),
  // 3. احمر محجب (Red Hijab)
  readWear3A: l("/rtw/red-hijab/DSC_1849 copy 2.jpg"),
  readWear3B: l("/rtw/red-hijab/DSC_1911 copy 2.jpg"),
  readWear3C: l("/rtw/red-hijab/DSC_1924 copy 2.jpg"),
  // 4. اسود2 (Black 2)
  readWear4A: l("/rtw/black-2/DSC_1588 copy 2.jpg"),
  readWear4B: l("/rtw/black-2/DSC_1631 copy.jpg"),
  readWear4C: l("/rtw/black-2/DSC_1793 copy.jpg"),
  // 5. افرهول (Jumpsuit)
  readWear5A: l("/rtw/jumpsuit/DSC_2022 copy.jpg"),
  readWear5B: l("/rtw/jumpsuit/DSC_2054 copy.jpg"),
  readWear5C: l("/rtw/jumpsuit/DSC_2101 copy.jpg"),
  // 6. بطيخي (Watermelon)
  readWear6A: l("/rtw/watermelon/DSC_6581 copy.jpg"),
  readWear6B: l("/rtw/watermelon/DSC_6582 copy.jpg"),
  readWear6C: l("/rtw/watermelon/DSC_6590 copy.jpg"),
  // 7. زهري (Rose Pink)
  readWear7A: l("/rtw/rose-pink/DSC_6892 copy.jpg"),
  readWear7B: l("/rtw/rose-pink/DSC_6900 copy 2.jpg"),
  readWear7C: l("/rtw/rose-pink/DSC_6911 copy.jpg"),
